...
// GET /homeowners/:id
router.get("/api/homeowner/:_id", (0, asyncWrapper_1.asyncWrapper)(controllers_1.getHomeownerById));
...
router.delete("/api/homeowner/:_id", (0, asyncWrapper_1.asyncWrapper)(controllers_1.deleteHomeownerById));
